  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        >
          <Text className="font-display text-2xl text-text">Binge</Text>
        ...
        >
          <SeriesRow
            ...
            onSeeAll={() => router.push({ pathname: '/series/view-all', params: { category: 'popular' } })}
          />
        </MotiView>
        ...
        >
          <SeriesRow
            ...
            onSeeAll={() => router.push({ pathname: '/series/view-all', params: { category: 'top_rated' } })}
          />
        </MotiView>
        ...
        >
          <SeriesRow
            ...
            onSeeAll={() => router.push({ pathname: '/series/view-all', params: { category: 'airing_today' } })}
          />
        </MotiView>
        ...
        >
          <SeriesRow
            ...
            onSeeAll={() => router.push({ pathname: '/series/view-all', params: { category: 'on_the_air' } })}
          />
        </MotiView>
